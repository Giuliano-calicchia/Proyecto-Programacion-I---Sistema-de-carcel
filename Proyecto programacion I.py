...
def ImpresionMatriz(matriz):
    """Funcion que se encarga de la impresion de la matriz utilizada como parametro.
    Tiene 2 posibles funciones, imprimir a la matriz de forma detallada y grafica, o imprimirla de forma simplificada.
    Esto dependera de la eleccion del usuario
    
    Parametro: Matriz a imprimir"""
